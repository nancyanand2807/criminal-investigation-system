...
% Last Modified by GUIDE v2.5 07-Apr-2017 23:11:23
...
[filename, pathname, filterindex] = uigetfile('*.*','Pick an Image');
file_loc = strcat(pathname,filename);
im = imread(file_loc);
setappdata(0,'im_value_loc',file_loc);
setappdata(0,'im_value',im);
setappdata(0,'im_value_1',im);
set(handles.edit2,'string',file_loc);
end
...
setappdata(0,'db_loc',folder_name);
